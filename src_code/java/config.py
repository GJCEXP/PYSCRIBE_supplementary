...
# from my_lib.util.eval.translate_metric import get_nltk33_sent_bleu1,get_nltk33_sent_bleu2,get_nltk33_sent_bleu3,\
#     get_nltk33_sent_bleu4,get_nltk33_sent_bleu as get_sent_bleu1,get_sent_bleu2,get_sent_bleu3,get_sent_bleu4,get_sent_bleu
...
# max_code_len=316     #285
max_code_str_len=10
max_ast_size=307
# max_ast_func_size=128
# max_ast_attr_size=173
max_text_len=40
...
params = dict(model_dir=model_dir,
              ...
              drop_rate=0.2,
              pad_idx=0,
              train_batch_size=144,  ####################192
              pred_batch_size=math.ceil(144 * 3),  ####################192*2.5
              gpu0_train_batch_size=30,  ####################40
              max_train_size=-1,  # -1 means all
              max_valid_size=math.ceil(144 * 3) * 10,  ####################10
